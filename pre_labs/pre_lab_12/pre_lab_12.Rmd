...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** The columns are both character data types. The column names are in title case and include spaces. 
```{r}
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer** I might want to add the press contact of the press release and the length (in words) of each release. 
...
tags there are in the HTML source? **Answer** It suggests that there is only one <ul> tag in the HTML. 
...
tags. Describe the output: **Answer** This code gives us a list of the items inside the <li> tags. Some of the items in the list are one word long (like what looks like a linkn to a social media page), others are full sentences. 
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** This code gives us the list that we made in the previous task as a dataframe. It is only one column with each row being an entry in the list. 
